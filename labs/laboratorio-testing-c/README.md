...
> R:Inicializa un carrito, es importante llamarla antes de usar para que se establezca su cantidad inicial de productos en 0
...
> R:Falla, esperaba 700 y recibe 350 de carrito_total
...
> R:Linea 24 BUG: falta multiplicar por cantidad

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R:Multiplicar la cantidad de ese producto cada vez que lo agrega al total
...
> R:test unitario verifica las funciones de forma aislada, mientras que el de integracion verifica que varias trabajen correctamente en conjunto. test_unitario
...
> R:Porque si se escribe fuera del tamaño del array, este puede acceder a una posición de memoria que pertenece a otra variable o estructura probocando corrupción de memoria o fallo en el programa
...
> R:Puedo comprobar el comportamiento esperado del programa
...
> R:no detectó el bug porque la cantidad era 1, por lo tanto al multiplicarlo iba a dar el mismo resultado que sin multiplicarlo
